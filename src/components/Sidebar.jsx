...
import { FiHome, FiFileText, FiBriefcase, FiUsers, FiSettings } from 'react-icons/fi';
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 h-screen sticky top-16 overflow-y-auto">
      <nav className="p-4">
        {menuItems.map((item) => {
